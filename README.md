...
- **Resilient AI Architecture:** Built-in multi-model fallback across Gemini models ensuring uninterrupted reliability.

---

## 🛠️ Architecture & Tech Stack
- **AI Engine:** Google Gemini (`gemini-2.0-flash`, `gemini-1.5-flash`) via `google-genai` SDK
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/your-username/LexiClear.git](https://github.com/your-username/LexiClear.git)
   cd LexiClear
